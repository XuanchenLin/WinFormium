...
public static unsafe class CefRuntime
{
    ...
    {
        WinFormium.Browser.CefGlue.Platform.Windows.NativeMethods.LoadLibraryEx(
            System.IO.Path.Combine(path, "libcef.dll"),
            IntPtr.Zero,
            WinFormium.Browser.CefGlue.Platform.Windows.LoadLibraryFlags.LOAD_WITH_ALTERED_SEARCH_PATH
            );
    }
